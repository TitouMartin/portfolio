    ...
    <div class="project-page">
        ...
        <div class="text-block project-page-big-margin">
            <div class="chips-container project-page-small-margin">
                ...
                <div class="chip red">BtoC</div>
                <div class="chip red">BtoB</div>
            </div>

            <div class="split project-page-small-margin">
                <div class="block">
                ...
                <div class="block">
                    ...
                    <div>
                        <ul>
                            ...
                            <li>User reaserch and new features design</li>
                            <li>Development progress monitoring, Q&A tests, sprint and roadmap advancement suppervision</li>
                            <li>Visual standardization of the solution</li>
        ...
        <div class="project-big-image-container amikeo-10-iphones">
            <img src="~/assets/images/amikeo/amikeo-10-iphones.png" />
        </div>

        <div class="project-image-double amikeo project-page-big-margin">
        ...
        <div class="project-big-image-container amikeo-user-journey project-page-big-margin">
            <img src="~/assets/images/amikeo/amikeo-user-journey.png" />
        </div>

        <div class="text-block project-page-big-margin">
            <div class="section-title">interfaces</div>
            <div><span class="outlined">Auticiel</span> has developed a Cloud platform enabling its professional clients to manage their tablet fleets. This platform includes a community library, allowing professionals to share customized content created for <span class="outlined">Auticiel</span>’s applications. Additionally, <span class="outlined">Auticiel</span>’s educational teams share a selection of content every month, centered around a specific theme.</div>
            <div>To make the applications more accessible for B2C users, <span class="outlined">Auticiel</span> decided to include access to the Cloud platform in the <span class="outlined">Amikeo</span> subscription. This allows B2C users to access, among other things, the community content library. Previously, users had to create the content they needed themselves. With this library, they can now share new content in their applications and begin using it immediately upon subscribing.</div>
        ...
        <div class="project-big-image-container amikeo-login-revamp">
            <div class="image-row old-login text-block">
                ...
                <img src="~/assets/images/amikeo/amikeo-old-login/old-login-1.png">
                <img src="~/assets/images/amikeo/amikeo-old-login/old-login-2.png">
                <img src="~/assets/images/amikeo/amikeo-old-login/old-login-3.png">
                <img src="~/assets/images/amikeo/amikeo-old-login/old-login-4.png">
            </div>

            <div class="image-row new-login text-block">
                <div class="became big-text">Became</div>
                <img src="~/assets/images/amikeo/amikeo-new-login/new-login-1.png">
                <img src="~/assets/images/amikeo/amikeo-new-login/new-login-2.png">
                <img src="~/assets/images/amikeo/amikeo-new-login/new-login-3.png">
                <img src="~/assets/images/amikeo/amikeo-new-login/new-login-4.png">
                <img src="~/assets/images/amikeo/amikeo-new-login/new-login-5.png">
                <img src="~/assets/images/amikeo/amikeo-new-login/new-login-6.png">
            </div>
        </div>
